...
/* Sync Template */
	...
	{
		.name = "xts(aes)",
		.driver_name = "xts-aes-du512-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER | CRYPTO_ALG_BULK_DU_512,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
			.encrypt = ssi_sblkcipher_encrypt,
			.decrypt = ssi_sblkcipher_decrypt,
	...
	{
		.name = "xts(aes)",
		.driver_name = "xts-aes-du4096-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER | CRYPTO_ALG_BULK_DU_4096,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
			.encrypt = ssi_sblkcipher_encrypt,
			.decrypt = ssi_sblkcipher_decrypt,
	...
	{
		.name = "essiv(aes)",
		.driver_name = "essiv-aes-du512-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER | CRYPTO_ALG_BULK_DU_512,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
	...
	{
		.name = "essiv(aes)",
		.driver_name = "essiv-aes-du4096-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER | CRYPTO_ALG_BULK_DU_4096,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
	...
	{
		.name = "bitlocker(aes)",
		.driver_name = "bitlocker-aes-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
	...
	{
		.name = "bitlocker(aes)",
		.driver_name = "bitlocker-aes-du512-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER | CRYPTO_ALG_BULK_DU_512,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
	...
	{
		.name = "bitlocker(aes)",
		.driver_name = "bitlocker-aes-du4096-dx-sync",
		.blocksize = AES_BLOCK_SIZE,
		.type = CRYPTO_ALG_TYPE_BLKCIPHER | CRYPTO_ALG_BULK_DU_4096,
		.template_sblkcipher = {
			.setkey = ssi_blkcipher_setkey,
