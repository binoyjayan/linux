...
struct geniv_operations {
	...
	int (*generator)(struct geniv_ctx_data *req, u8 *iv, struct dm_crypt_request *dmreq);
	int (*post)(struct geniv_ctx_data *cd, u8 *iv, struct dm_crypt_request *dmreq);
};
